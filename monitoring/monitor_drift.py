...
from evidently.metrics import ClassificationPRCurve, ClassificationConfusionMatrix, ClassificationClassBalance
...
data_drift_report.run(reference_data=train_data.drop(columns=[target, prediction]),
...
performance_report.run(reference_data=train_data[[target, prediction]],
